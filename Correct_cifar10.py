...
#Maximum validation accuracy: 81.78% (on 15 epochs; withoun any image processing)
...
X_tr = X_train.reshape(-1,1,32,32,3)
X_te = X_test.reshape(-1,1,32,32,3)
X_tr=X_tr/255.0
X_te=X_te/255.0
...
model.add(Conv2D(128, kernel_size = 5, activation='softmax'))
model.add(BatchNormalization())
